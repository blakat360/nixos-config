...
let
    ...
    * {
        ...
        active-background:           @alternate-normal-background;
	...
	'';
	file_name = "rofi/theme.rasi";
in
{
  xdg.configFile."${file_name}".text = theme;
  programs.rofi.theme = "${config.xdg.configHome}/${file_name}";
}
